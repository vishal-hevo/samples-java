...
public class IncrementalStarter {
  static final String TASK_QUEUE = "MutexTaskQueue";
  static final String INTEGRATION_ID = "integration";
  ...
  public static void main(String[] args) throws Exception {
    ...
    WorkflowOptions workflowOptions =
        WorkflowOptions.newBuilder()
            ...
            .setWorkflowId(String.format("incremental_workflow:%s", INTEGRATION_ID))
            .build();

    IncrementalWorkflow workflow =
